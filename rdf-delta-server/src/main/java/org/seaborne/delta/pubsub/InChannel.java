...
import org.seaborne.delta.server.handlers.PHandlerLocalDB ;
...
public class InChannel {
    /*
     * In-bound prcessing: parse (=check) and then write to disk. 
    ...
    public synchronized void deliver(InputStream in) {
