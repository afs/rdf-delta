...
// Originally DatasetGraphOne from Apache Jena:
/*
...
public class DatasetGraphOneX extends DatasetGraphBaseFind {
    ...
    public DatasetGraphOneX(Graph graph, DatasetGraph backing) {
        this.graph = graph;
        backingDGS = backing;
    ...
    public DatasetGraphOneX(Graph graph) {
        this.graph = graph;
    ...
    public DatasetGraphOneX(Graph graph, Transactional transactional) {
        this.graph = graph;
        backingDGS = null;
