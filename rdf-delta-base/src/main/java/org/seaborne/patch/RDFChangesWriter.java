...
import static org.seaborne.patch.ChangeCode.* ;
...
import org.seaborne.patch.tio.TokenOutputStream ;
import org.seaborne.patch.tio.TokenOutputStreamWriter ;
...
public class RDFChangesWriter implements RDFChanges {
    ...
    public RDFChangesWriter(OutputStream out) {
        this.out = out ;
