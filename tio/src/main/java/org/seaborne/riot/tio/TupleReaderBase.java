...
public class TupleReaderBase {}

///** Tokenizer that sorts out prefixes and groups into sequences of token */
//public class TupleReaderBase implements TokenInputStream {
//    private static Logger       log      = LoggerFactory.getLogger(TupleReaderBase.class) ;
...
//
//    public TupleReaderBase(String label, Tokenizer tokens) {
//        if ( false )
