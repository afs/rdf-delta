  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      ...
      case TXN:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type Transaction for field 'txn', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        ...
        case TXN:
          if (field.type == TXN_FIELD_DESC.type) {
            Transaction txn;
            txn = org.seaborne.patch.binary.thrift.Transaction.findByValue(iprot.readI32());
            return txn;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
